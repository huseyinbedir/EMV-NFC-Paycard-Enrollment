...
public enum EmvCardScheme {
	...
	//VISA("VISA", "^4[0-9]{6,}$", "A0 00 00 00 03", "A0 00 00 00 03 10 10", "A0 00 00 00 98 08 48","A0 00 00 00 03 20 10","A0 00 00 00 03 20 20","A0 00 00 00 03 00 00 00","A0 00 00 00 03 00 03 75 61"), //
	VISA("VISA", "^4[0-9]{6,}$", "A0 00 00 00 03 00 00 00",  "A0 00 00 00 03 00 03 75 61",  "A0 00 00 00 03 05 07 60 10",  "A0 00 00 00 03 10 10",  "A0 00 00 00 03 10 10 01",  "A0 00 00 00 03 10 10 02",  "A0 00 00 00 03 20 10",  "A0 00 00 00 03 20 20",  "A0 00 00 00 03 30 10",  "A0 00 00 00 03 40 10",  "A0 00 00 00 03 50 10",  "A0 00 00 00 03 53 44 41",  "A0 00 00 00 03 53 50",  "A0 00 00 00 03 53 50 41",  "A0 00 00 00 03 60 10",  "A0 00 00 00 03 60 20",  "A0 00 00 00 03 80 02",  "A0 00 00 00 03 80 10",  "A0 00 00 00 03 90 10",  "A0 00 00 00 03 99 99 10"), //
	TROY("TROY", "^9[0-9]{6,}$", "A0 00 00 06 72 30 10","A0 00 00 06 72 30 20"), //
	GELDKARTE("GeldKarte/ZKA", null, "D2 76 00 00 25 45 50 02 00", "D2 76 00 00 25 45 50 01 00", "D2 76 00 00 25"),
	MASTER_CARD("Master card", "^5[1-5][0-9]{5,}$", "A0 00 00 00 04", "A0 00 00 00 05","A0 00 00 00 04 10 10","A0 00 00 00 04 99 99","A0 00 00 00 04 30 60","A0 00 00 00 04 60 00","A0 00 00 00 05 00 01"); //
